exports.asyncBrowserScript = async () => {
    let arrErr = null;
    ...
    if (typeof jQuery != "undefined") {
      ...
      function checkForMissingIds() {
        ...
        return elsMissingIDs;
      }

      return await new Promise((res) => {
        let errVals = arrErr.map(val => val.error);
        errVals = [...new Set(errVals)];
        console.log("new arr:", errVals);
        res({ 
            title,
            url,
            errVals,
